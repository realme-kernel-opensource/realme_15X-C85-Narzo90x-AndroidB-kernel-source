 ...
 ** OPLUS_EDIT
 ** File: ae259_p_7_a0030_hd_dsi_vdo.c
...
#endif
#include "ae259_p_7_a0030_hd_dsi_vdo.h"
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xAE, 0xDD);
	...
	jdi_dcs_write_seq_static(ctx, 0xB5, 0xD9);
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "ae259,p_7,a0030,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "ae259_p_7_a0030_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("AE259 P_7 A0030 VDO 120HZ LCD Panel Driver");
