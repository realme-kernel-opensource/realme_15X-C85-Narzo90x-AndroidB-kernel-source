 ...
 ** OPLUS_EDIT
 ** File: oplus23700_tm_nt36672c_fhd_dsi_vdo.h
...
#endif
#include "oplus23700_tm_nt36672c_fhd_dsi_vdo.h"
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xFF, 0x23);  /* CABC code */
	jdi_dcs_write_seq_static(ctx, 0xFB, 0x01);
	...
	jdi_dcs_write_seq_static(ctx, 0x2B, 0x9D);

	jdi_dcs_write_seq_static(ctx, 0x30, 0xFE);
	jdi_dcs_write_seq_static(ctx, 0x31, 0xF9);
	jdi_dcs_write_seq_static(ctx, 0x32, 0xF8);
	jdi_dcs_write_seq_static(ctx, 0x33, 0xF2);
	jdi_dcs_write_seq_static(ctx, 0x34, 0xEF);
	jdi_dcs_write_seq_static(ctx, 0x35, 0xED);
	jdi_dcs_write_seq_static(ctx, 0x36, 0xEC);
	jdi_dcs_write_seq_static(ctx, 0x37, 0xEB);
	jdi_dcs_write_seq_static(ctx, 0x38, 0xE9);
	jdi_dcs_write_seq_static(ctx, 0x39, 0xE6);
	jdi_dcs_write_seq_static(ctx, 0x3A, 0xE2);
	jdi_dcs_write_seq_static(ctx, 0x3B, 0xE1);
	jdi_dcs_write_seq_static(ctx, 0x3D, 0xDD);
	jdi_dcs_write_seq_static(ctx, 0x3F, 0xDC);
	jdi_dcs_write_seq_static(ctx, 0x40, 0xDB);
	jdi_dcs_write_seq_static(ctx, 0x41, 0xDA);

	jdi_dcs_write_seq_static(ctx, 0x45, 0xF7);
	jdi_dcs_write_seq_static(ctx, 0x46, 0xF6);
	jdi_dcs_write_seq_static(ctx, 0x47, 0xF2);
	jdi_dcs_write_seq_static(ctx, 0x48, 0xED);
	jdi_dcs_write_seq_static(ctx, 0x49, 0xE9);
	jdi_dcs_write_seq_static(ctx, 0x4A, 0xE3);
	jdi_dcs_write_seq_static(ctx, 0x4B, 0xDD);
	jdi_dcs_write_seq_static(ctx, 0x4C, 0xDB);
	jdi_dcs_write_seq_static(ctx, 0x4D, 0xD7);
	jdi_dcs_write_seq_static(ctx, 0x4E, 0xCD);
	jdi_dcs_write_seq_static(ctx, 0x4F, 0xC6);
	jdi_dcs_write_seq_static(ctx, 0x50, 0xC4);
	jdi_dcs_write_seq_static(ctx, 0x51, 0xC2);
	jdi_dcs_write_seq_static(ctx, 0x52, 0xC0);
	jdi_dcs_write_seq_static(ctx, 0x53, 0xB9);
	jdi_dcs_write_seq_static(ctx, 0x54, 0xB1);
	jdi_dcs_write_seq_static(ctx, 0x58, 0xDB);
	jdi_dcs_write_seq_static(ctx, 0x59, 0xDA);
	jdi_dcs_write_seq_static(ctx, 0x5A, 0xD3);
	jdi_dcs_write_seq_static(ctx, 0x5B, 0xCF);
	jdi_dcs_write_seq_static(ctx, 0x5C, 0xCD);
	jdi_dcs_write_seq_static(ctx, 0x5D, 0xC3);
	jdi_dcs_write_seq_static(ctx, 0x5E, 0xBF);
	jdi_dcs_write_seq_static(ctx, 0x5F, 0xBD);
	jdi_dcs_write_seq_static(ctx, 0x60, 0xB4);
	jdi_dcs_write_seq_static(ctx, 0x61, 0xB3);
	jdi_dcs_write_seq_static(ctx, 0x62, 0xB2);
	jdi_dcs_write_seq_static(ctx, 0x63, 0xB1);
	jdi_dcs_write_seq_static(ctx, 0x64, 0xB0);
	jdi_dcs_write_seq_static(ctx, 0x65, 0xAA);
	jdi_dcs_write_seq_static(ctx, 0x66, 0xA9);
	jdi_dcs_write_seq_static(ctx, 0x67, 0xA8);
	...
	jdi_dcs_write_seq_static(ctx, 0xFB, 0x01);
	jdi_dcs_write_seq_static(ctx, 0x6D, 0x77);
	...
	jdi_dcs_write_seq_static(ctx, 0x68, 0x03, 0x02);
...
static struct mtk_panel_params ext_params_45hz = {
                .vendor = "nt36672c_barley",
                .manufacture = "23700_tm_nt36672c",
                .pll_clk = PLL_CLOCK,
                .cust_esd_check = 1,
                .esd_check_enable = 1,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "nt36672c_barley", "23700_tm_nt36672c");
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus23700_tm_nt36672c_fhd_dsi_vdo",
                .owner = THIS_MODULE,
