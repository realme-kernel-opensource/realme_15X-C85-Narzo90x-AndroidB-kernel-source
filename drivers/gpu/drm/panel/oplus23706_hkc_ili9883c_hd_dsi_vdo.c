...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0x7F, 0x6B);
        jdi_dcs_write_seq_static(ctx, 0x61, 0x01);
        jdi_dcs_write_seq_static(ctx, 0x68, 0x3E);
        jdi_dcs_write_seq_static(ctx, 0x66, 0x33);
        jdi_dcs_write_seq_static(ctx, 0x65, 0x07);

        jdi_dcs_write_seq_static(ctx, 0xA5, 0x7B);
        jdi_dcs_write_seq_static(ctx, 0x4F, 0x7E);
        jdi_dcs_write_seq_static(ctx, 0x5D, 0x55);
        ...
        jdi_dcs_write_seq_static(ctx, 0x74, 0xCD);
        jdi_dcs_write_seq_static(ctx, 0x75, 0x93);
        jdi_dcs_write_seq_static(ctx, 0x76, 0x93);
        jdi_dcs_write_seq_static(ctx, 0x77, 0x93);

        jdi_dcs_write_seq_static(ctx, 0x7A, 0xB5);
        jdi_dcs_write_seq_static(ctx, 0x7B, 0x8D);
        jdi_dcs_write_seq_static(ctx, 0x7C, 0x8D);
        jdi_dcs_write_seq_static(ctx, 0x7D, 0x8D);
        jdi_dcs_write_seq_static(ctx, 0x80, 0x93);
        jdi_dcs_write_seq_static(ctx, 0x81, 0x6B);
        jdi_dcs_write_seq_static(ctx, 0x82, 0x6B);
        jdi_dcs_write_seq_static(ctx, 0x83, 0x6B);

        jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x07);
        jdi_dcs_write_seq_static(ctx, 0xC0, 0x01);
        jdi_dcs_write_seq_static(ctx, 0xCB, 0xA2);
        jdi_dcs_write_seq_static(ctx, 0xCC, 0x9D);
        jdi_dcs_write_seq_static(ctx, 0xCD, 0x8E);
