 ...
 ** OPLUS_EDIT
 ** File: oplus24707_csot_td4376b_fhd_dsi_vdo.h
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xF0, 0x5E, 0x01, 0x30);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x03, 0x41);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x2e, 0x0b);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x2f, 0x54);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x30, 0x11);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x31, 0x94);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x32, 0x15);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x33, 0x7c);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x34, 0x17);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x35, 0xe8);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x36, 0x19);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x37, 0x32);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x38, 0x20);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x39, 0x6c);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xC1, 0x57, 0x04);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBE, 0x01, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x00, 0x4f);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x01, 0x59);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x02, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x03, 0xbe);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x04, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x05, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB8, 0x06, 0x0a);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x00, 0x57);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x01, 0x59);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x02, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x03, 0xbe);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x04, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x05, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xB9, 0x06, 0x0a);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x00, 0x9f);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x01, 0x65);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x02, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x03, 0xbe);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x04, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x05, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xBA, 0x06, 0x10);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x00, 0x77);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x01, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x02, 0x04);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x03, 0x10);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x04, 0x31);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x05, 0x33);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x06, 0x3f);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x07, 0x4b);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x08, 0x57);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x09, 0x63);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0A, 0x79);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0B, 0x87);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0C, 0x93);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0D, 0xa4);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0E, 0xb4);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0F, 0xc0);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x10, 0xcd);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x11, 0xdb);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x12, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x14, 0x40);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x15, 0x40);
	jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x1B, 0x43);
...
#define VAC (2400)
#define HAC (1080)
#define VFP_30hz (7560)
#define VFP_45hz (4230)
#define VFP_48hz (3810)
#define VFP_50hz (3560)
#define VFP_60hz (2572)
#define VFP_90hz (896)
#define VFP_120hz (68)
...
static const struct drm_display_mode default_mode_30hz = {
        .clock = ((HAC + HFP + HSA + HBP) * (VAC + VFP_30hz + VSA + VBP) * 30) / 1000,
        .hdisplay = HAC,
        .hsync_start = HAC + HFP,
...
static const struct drm_display_mode default_mode_48hz = {
	.clock = ((HAC + HFP + HSA + HBP) * (VAC + VFP_48hz + VSA + VBP) * 48) / 1000,
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA,
	.htotal = HAC + HFP + HSA + HBP,
...
static const struct drm_display_mode default_mode_50hz = {
	.clock = ((HAC + HFP + HSA + HBP) * (VAC + VFP_50hz + VSA + VBP) * 50) / 1000,
	.hdisplay = HAC,
	.hsync_start = HAC + HFP,
	.hsync_end = HAC + HFP + HSA,
	.htotal = HAC + HFP + HSA + HBP,
...
static struct mtk_panel_params ext_params_30hz = {
	.vendor = "td4376b_rado",
	.manufacture = "24707_csot_td4376b",
	.pll_clk = PLL_CLOCK,
	.cust_esd_check = 1,
	.esd_check_enable = 1,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "td4376b_rado", "24707_csot_td4376b");
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "oplus24707,csot,td4376b,fhd,dsi,vdo",
	},
	{
	}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "oplus24707_csot_td4376b_fhd_dsi_vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("CSOT TD4376B VDO 120HZ LCD Panel Driver");
