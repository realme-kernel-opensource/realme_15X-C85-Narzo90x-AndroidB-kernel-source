...
int tp_util_get_vendor(struct hw_resource *hw_res, struct panel_info *panel_data)
{
	...
	if ((prj_id == 24707) || (prj_id == 24609) || (prj_id == 24710) || (prj_id == 24711)) {
		...
		} else if (strstr(tp_dsi_display_primary, "oplus24707_csot_td4376b_fhd_dsi_vdo_lcm_drv-nf_td4377")) {
			pr_err("[TP]project is rado-FHD 3\n");
			strcpy(panel_data->manufacture_info.manufacture, vendor);
			memcpy(panel_data->manufacture_info.version, "0xAB936HX001", 12);
			panel_data->firmware_headfile.firmware_data = FW_24707_TD4376_HUAXING;
			panel_data->firmware_headfile.firmware_size = sizeof(FW_24707_TD4376_HUAXING);
		}
	}
