...
static struct wl2866d_ldomap ldolist_mumbai[] = {
    //main 50M
    {IMGSENSOR_SENSOR_IDX_MAIN, AVDD, MAIN_AVDD1}, //BackMain AVDD
    {IMGSENSOR_SENSOR_IDX_MAIN, DVDD, MAIN_DVDD1}, //BackMain DVDD
    //{IMGSENSOR_SENSOR_IDX_MAIN, DOVDD, MAIN_DOVDD}, //BackMain DOVDD
...
static struct wl2866d_ldomap ldolist_mumbaih[] = {
    //main 50M
    {IMGSENSOR_SENSOR_IDX_MAIN, AVDD, MAIN_AVDD1}, //BackMain AVDD
    {IMGSENSOR_SENSOR_IDX_MAIN, DVDD, MAIN_DVDD1}, //BackMain DVDD
    //{IMGSENSOR_SENSOR_IDX_MAIN, DOVDD, MAIN_DOVDD}, //BackMain DOVDD
    ...
    enum IMGSENSOR_HW_PIN_STATE pin_state)
{
    ...
    if (is_project(24699) || is_project(24601) || is_project(24683) ||
    ...
    } else if (is_project(24751) || is_project(24752) || is_project(24782)) {
        ...
        is_project(25722) || is_project(25730) || is_project(25731)) {
    ...
    } else if (is_project(25747) || is_project(24748) || is_project(25622)) {
        for(i = 0; i < (sizeof(ldolist_mumbaih) / sizeof(ldolist_mumbaih[0])); i++) {
            if(sensor_idx == ldolist_mumbaih[i].sensor_index && pin == ldolist_mumbaih[i].seq_type) {
               ldonum = ldolist_mumbaih[i].ldo_selected;
               WL2866D_PRINT("[wl2866d_hw] %s sensor %d, seq_type = %d matched ldo %d\n", __FUNCTION__, sensor_idx, pin, ldonum + 1);
               break;
            }
        }
