...
#include "gc50f6mipi_otp_mumbaid.h"

/****************************Modify Following Strings for Debug**************************/
#define PFX "GC50F6DMIPI_OTP"
/****************************   Modify end    *******************************************/
#define GC50F6D_OTP_DEBUG 1
#if GC50F6D_OTP_DEBUG
...
/*for debug*/
#define CT_DEBUG            1
static DEFINE_MUTEX(ct_data_mutex);
...
void gc50f6d_mumbaid_read_crosstalk_data(void)
{
	kal_uint16 i = 0;
...
void gc50f6d_mumbaid_copy_crosstalk_data(kal_uint8 *ct_data)
{
...
void gc50f6d_mumbaid_otp_identify(void)
{
	LOG_INF("start hyper otp_identify");
	gc50f6d_mumbaid_read_crosstalk_data();
