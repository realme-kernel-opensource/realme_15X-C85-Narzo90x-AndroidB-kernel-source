 ...
 * Filename:
 * ---------
 *     gc50f6mipiraw_mumbaid_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _GC50F6MIPI_MUMBAID_SENSOR_H
#define _GC50F6MIPI_MUMBAID_SENSOR_H
...
#define GC50F6D_MIRROR_NORMAL    1
#define GC50F6D_MIRROR_HORIZON   0
#define GC50F6D_MIRROR_VERTICAL  0
#define GC50F6D_MIRROR_HV        0

#if GC50F6D_MIRROR_NORMAL
#define GC50F6D_MIRROR       0x00

#elif GC50F6D_MIRROR_HORIZON
#define GC50F6D_MIRROR       0x01

#elif GC50F6D_MIRROR_VERTICAL
#define GC50F6D_MIRROR       0x02

#elif GC50F6D_MIRROR_HV
#define GC50F6D_MIRROR       0x03
...
extern void gc50f6d_mumbaid_copy_crosstalk_data(kal_uint8 *ct_data);
extern void gc50f6d_mumbaid_otp_identify(void);
