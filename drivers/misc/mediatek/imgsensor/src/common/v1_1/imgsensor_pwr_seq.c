...
#endif
#if defined(IMX852_MIPI_RAW_MUMBAIH)
    {
        SENSOR_DRVNAME_IMX852_MIPI_RAW_MUMBAIH,
        {
              {RST, Vol_Low, 1},
              {DOVDD, Vol_1800, 1},
              {AVDD, Vol_2900, 2},
...
#endif
#if defined(IMX480_MIPI_RAW_MUMBAIH)
    {
        SENSOR_DRVNAME_IMX480_MIPI_RAW_MUMBAIH,
        {
            {RST, Vol_Low, 1},
            {AVDD, Vol_2900, 0},
            {DVDD, Vol_1100, 0},
...
#endif
#if defined(SC202CS_MIPI_RAW_MUMBAIH)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_MUMBAIH,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},//5
            {AVDD, Vol_2800, 1},//3
