...
#include "sc202csmipiraw_mumbaih_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_mumbaih"
...
#define DEVICE_VERSION_MUMBAIH_SC202CS    "sc202cs"
static kal_uint8 deviceInfo_register_value = 0x00;

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC202CS_SENSOR_ID_MUMBAIH,
        ...
        do {
			*sensor_id = return_sensor_id();
            pr_err("cwd return_sensor_id:0x%x\n",*sensor_id);
             if (*sensor_id == imgsensor_info.sensor_id - 0x7) {
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                imgsensor_info.module_id = 0x00;
             if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_r1", DEVICE_VERSION_MUMBAIH_SC202CS, imgsensor_info.module_id);
...
static kal_uint32 open(void)
{
    ...
    if (imgsensor_info.sensor_id - 0x7 != sensor_id)
       return ERROR_SENSOR_CONNECT_FAIL;
...
UINT32 SC202CS_MIPI_RAW_MUMBAIH_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
