...
#define AF_DRVNAME "DW9800WAF_BARLEY_DRV"
...
static int s4DW9800WAF_BARLEY_ReadReg(unsigned short *a_pu2Result)
{
...
{
	int ret = 0;
	printk("zbfdbg DW9800WAF_BARLEY\n");
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9800WAF_BARLEY_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9800WAF_BARLEY_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800WAF_BARLEY_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800WAF_BARLEY_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800WAF_BARLEY_GetFileName(unsigned char *pFileName)
{
